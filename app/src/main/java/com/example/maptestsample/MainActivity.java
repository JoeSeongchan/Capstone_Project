...
//        Toast.makeText(LocationDemoActivity.this, "Reverse Geo-coding : " + result, Toast.LENGTH_SHORT).show();
   ...
   private void searchKeyword(String keyword){
       ...
       Log.d("WANTSLEEP","\nCenter"+"x: "+mapCenter_x+"\n"+"y: "+mapCenter_y+"\nString x: "+x+"   String y: "+y+"\n\n");
        ...
        Call<ResultSearchKeyword> call = spotInterface.getSearchKeyword(API_KEY, keyword, x, y, radius);
    ...
    private void addItems(ResultSearchKeyword searchResult){
        ...
        for(Place data : dataArr){
            ...
            marker.setMapPoint(MapPoint.mapPointWithGeoCoord(Double.parseDouble(data.y), Double.parseDouble(data.x)));
    ...
    public void onCalloutBalloonOfPOIItemTouched(MapView mapView, MapPOIItem mapPOIItem, MapPOIItem.CalloutBalloonButtonType calloutBalloonButtonType) {
        ...
        Log.d("TEST","---------\n"+"Place.name: "+place_name+" Phone num: "+phone+" Address1: " +address_name+" Address2: "+ road_address_name+"\n");
        //Log.d("TEST","-------\n"+"x: "+"\n"+"D_y: "+(Math.floor(lng*1000000)/1000000.0)+"\n");

        DetailInfo detailInfo = DetailInfo.newInstance(place_name, phone, address_name, road_address_name);
